        ...
        <div className="flex flex-col justify-between items-center h-full w-full gap-8">
          ...
          <div className="flex flex-row justify-start items-center w-full h-full">
            <div className="h-full flex flex-col justify-center items-center border border-[#f7f7f7] border-b-0 rounded-t-[5%] lg:w-[60%] xl:w-[60%] relative">
              ...
              <img
                src="/assets/svg/secured.svg"
                className="absolute z-25 top-[1/4] -right-[35%] w-[60%] "
                alt=""
              />
              <img
                src="/assets/svg/response.svg"
                className="absolute z-25 top-[1/4] left-[35%] w-[60%] "
                alt=""
              />
              <img
                src="/assets/svg/circle.svg"
                className="absolute z-25 top-[20%] left-[10%] "
                alt=""
              />
            </div>
          </div>
